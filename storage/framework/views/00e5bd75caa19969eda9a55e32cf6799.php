<div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tp-header-action d-flex align-items-center', $class ?? null]); ?>">
    <?php if(isset($showSearchButton) && $showSearchButton): ?>
    ...
    <?php if(is_plugin_active('ecommerce')): ?>
        <?php if(EcommerceHelper::isCompareEnabled()): ?>
            <div class="tp-header-action-item">
                <a href="<?php echo e(route('public.compare')); ?>" class="tp-header-action-btn">
                    ...
                    <span class="tp-header-action-badge" data-bb-value="compare-count"><?php echo e(Cart::instance('compare')->count()); ?></span>
                </a>
            </div>
        <?php endif; ?>
        <?php if(EcommerceHelper::isWishlistEnabled()): ?>
            <div class="tp-header-action-item d-none d-lg-block">
                <a href="<?php echo e(route('public.wishlist')); ?>" class="tp-header-action-btn">
                    ...
                    <span class="tp-header-action-badge" data-bb-value="wishlist-count"><?php echo e(Cart::instance('wishlist')->count()); ?></span>
                </a>
            </div>
        <?php endif; ?>
        <?php if(EcommerceHelper::isCartEnabled()): ?>
            <div class="tp-header-action-item">
                <button type="button" class="tp-header-action-btn cartmini-open-btn" data-bb-toggle="open-mini-cart" data-url="<?php echo e(route('public.ajax.cart-content')); ?>">
                    ...
                    <span class="tp-header-action-badge" data-bb-value="cart-count"><?php echo e(Cart::instance('cart')->count()); ?></span>
                </button>
            </div>
        <?php endif; ?>
    <?php endif; ?>
...
<?php /**PATH C:\Users\Andropedia_2025\Desktop\anali\kiyawallet\platform\themes/shofy/partials/header/actions.blade.php ENDPATH**/ ?>