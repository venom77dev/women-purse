<section class="tp-subscribe-area tp-subscribe-square pt-70 pb-65 theme-bg p-relative z-index-1">
    <div class="tp-subscribe-shape">
        <?php $__currentLoopData = range(1, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e(RvMedia::image(Arr::get($config, "shape_$i") ?: Theme::asset()->url("images/newsletter/shape-$i.png"), $config['title'], attributes: ['class' => "tp-subscribe-shape-$i"])); ?>

        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <div class="tp-subscribe-plane">
            <img class="tp-subscribe-plane-shape" src="<?php echo e(Theme::asset()->url('images/newsletter/plane.png')); ?>" alt="<?php echo e($config['title']); ?>">
            ...
            <div class="col-xl-7 col-lg-7">
                <div class="tp-subscribe-content">
                    <?php if($config['subtitle']): ?>
                        <span><?php echo BaseHelper::clean($config['subtitle']); ?></span>
                    <?php endif; ?>
                    <?php if($config['title']): ?>
                        <h3 class="tp-subscribe-title"><?php echo BaseHelper::clean($config['title']); ?></h3>
                    <?php endif; ?>
                </div>
            </div>
...
<?php /**PATH C:\Users\Andropedia_2025\Desktop\anali\kiyawallet\platform\themes/shofy-fashion/////widgets/newsletter/templates/frontend.blade.php ENDPATH**/ ?>