<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
    <div class="tp-footer-widget footer-col-4 mb-50">
        <h4 class="tp-footer-widget-title"><?php echo e($config['name']); ?></h4>
        <div class="tp-footer-widget-content">
            <?php if($config['phone']): ?>
                <div class="tp-footer-talk mb-20">
                    <span><?php echo e($config['phone_label']); ?></span>
                    <h4><a href="tel:<?php echo e($config['phone']); ?>"><?php echo e($config['phone']); ?></a></h4>
                </div>
            <?php endif; ?>
            <div class="tp-footer-contact">
                <?php if($config['email']): ?>
                    <div class="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div class="tp-footer-contact-content">
                            <p><?php echo Html::mailto($config['email']); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if($config['address']): ?>
                    <div class="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div class="tp-footer-contact-content">
                            <p>
                                <a href="https://maps.google.com/?q=<?php echo e($config['address']); ?>" target="_blank">
...
<?php /**PATH C:\Users\Andropedia_2025\Desktop\anali\kiyawallet\platform\themes/shofy/////widgets/site-contact/templates/frontend.blade.php ENDPATH**/ ?>