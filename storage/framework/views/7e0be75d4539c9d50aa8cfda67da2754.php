...
<h1 class="tp-product-details-title"><?php echo e($product->name); ?></h1>
    ...
    <?php if(EcommerceHelper::isReviewEnabled()): ?>
        <div class="tp-product-details-rating-wrapper d-flex align-items-center mb-10">
            ...
            <div class="tp-product-details-reviews">
                <a href="<?php echo e($product->url); ?>#product-review" data-bb-toggle="scroll-to-review"><?php echo e(__('(:count reviews)', ['count' => number_format($product->reviews_count)])); ?></a>
            </div>
        </div>
    <?php endif; ?>
</div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::form.index','data' => ['url' => route('public.cart.add-to-cart'),'method' => 'POST','class' => 'product-form']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('public.cart.add-to-cart')),'method' => 'POST','class' => 'product-form']); ?>
    ...
    <?php if($product->variations->isNotEmpty()): ?>
        <?php echo render_product_swatches($product, ['selected' => $selectedAttrs]); ?>
    ...
    <?php echo $__env->make(Theme::getThemeNamespace('views.ecommerce.includes.product-availability'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php if(isset($flashSale)): ?>
...
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-flame'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                <?php echo e(__('Flash Sale end in:')); ?>

            </h4>
            <div class="tp-product-details-countdown-time" data-countdown data-date="<?php echo e($flashSale->end_date); ?>">
                <ul>
    ...
    <?php if(EcommerceHelper::isCartEnabled()): ?>
        ...
        ?>
        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tp-product-details-action-wrapper mt-3', 'tp-cart-disabled' => $isOutOfStock]); ?>">
            <h3 class="tp-product-details-action-title"><?php echo e(__('Quantity')); ?></h3>
            <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                <div class="tp-product-details-quantity">
                    <div class="tp-product-quantity mb-15 mr-15">
                        ...
                        <input class="tp-cart-input" type="number" name="qty" min="1" value="1" max="<?php echo e($product->with_storehouse_management ? $product->quantity : 1000); ?>" <?php if($isOutOfStock): echo 'readonly'; endif; ?> />
                ...
                <div class="tp-product-details-add-to-cart mb-15 w-100">
                    <button
                        type="submit"
                        name="add-to-cart"
                        class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tp-product-details-add-to-cart-btn w-100', 'btn-disabled' => $isOutOfStock]); ?>"
            ...
            <?php if(EcommerceHelper::isQuickBuyButtonEnabled()): ?>
                <button
                    type="submit"
                    name="checkout"
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tp-product-details-buy-now-btn w-100', 'btn-disabled' => $isOutOfStock]); ?>"
                    <?php if($isOutOfStock): echo 'disabled'; endif; ?>
                    <?php echo EcommerceHelper::jsAttributes('buy-now-in-form', $product); ?>
    ...
    <div class="tp-product-details-action-sm">
        <?php if(EcommerceHelper::isCompareEnabled()): ?>
            <button
                type="button"
                class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tp-product-details-action-sm-btn', 'active' => is_product_in_compare($product->original_product->id)]); ?>"
        ...
        <?php if(EcommerceHelper::isWishlistEnabled()): ?>
            <button
                type="button"
                class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tp-product-details-action-sm-btn', 'active' => is_product_in_wishlist($product->original_product->id)]); ?>"
...
<div class="tp-product-details-query">
    <div class="tp-product-details-query-item " style="<?php echo \Illuminate\Support\Arr::toCssStyles(['display: none' => ! $product->sku]) ?>">
        <span><?php echo e(__('SKU:')); ?></span>
        <span data-bb-value="product-sku"><?php echo e($product->sku); ?></span>
    </div>
    <?php if($product->categories->isNotEmpty()): ?>
        <div class="tp-product-details-query-item">
            ...
            <?php $__currentLoopData = $product->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($category->url); ?>"><?php echo e($category->name); ?></a><span class="me-1"><?php if(!$loop->last): ?>,<?php endif; ?></span>
    ...
    <?php if($product->tags->isNotEmpty()): ?>
        <div class="tp-product-details-query-item">
            ...
            <?php $__currentLoopData = $product->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($tag->url); ?>"><?php echo e($tag->name); ?></a><span class="me-1"><?php if(!$loop->last): ?>,<?php endif; ?></span>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    <?php endif; ?>
</div>
<?php /**PATH C:\Users\Andropedia_2025\Desktop\anali\kiyawallet\platform\themes/shofy/views/ecommerce/includes/product-detail.blade.php ENDPATH**/ ?>