                                ...
                                <?php if(isset($payments)): ?>
                                    <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="<?php echo e($key % 2 == 0 ? 'even' : 'odd'); ?>">
                                            <td class="text-center no-column-visibility column-key-0 sorting_1"><?php echo e($item->id ?  : '--'); ?></td>
                                            <td class="  text-start  column-key-1">
                                                <?php echo e($item->name ?  : '--'); ?>

                                            </td>
                                            <td class="column-key-2"><?php echo e($item->pg_name_id ?  : '--'); ?></td>
                                            <td class="column-key-2"><?php echo e($item->pg_meta_id ?  : '--'); ?></td>
                                            <td class="column-key-2"><?php echo e($item->slug ?  : '--'); ?></td>
                                            <td class="  text-center  column-key-3">
                                                <span class="badge <?php echo e($item->status ? 'bg-success text-success-fg'  : 'bg-danger text-danger-fg'); ?>"><?php echo e($item->status ? 'Active'  : 'InActive'); ?></span>
                                            </td>
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    <div class="table-actions">
                                                        <a href="#" class="btn btn-sm btn-icon btn-primary editPayment" data-id="<?php echo e($item->id); ?>">
                                                        ...
                                                        <?php if($item->name !='COD' ): ?>
                                                            <a  class="btn btn-sm btn-icon btn-danger deletePayment" data-id="<?php echo e($item->id); ?>" href="#">
                                                                <svg class="icon" data-bs-toggle="tooltip"
...
<?php /**PATH C:\Users\Andropedia_2025\Desktop\anali\kiyawallet\resources\views/custom_pg_table.blade.php ENDPATH**/ ?>