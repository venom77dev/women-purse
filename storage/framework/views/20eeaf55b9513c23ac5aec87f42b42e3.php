<section class="tp-blog-area pt-110 pb-120">
    <div class="container">
                    ...
                    <div class="tp-blog-item-2 mb-40">
                        <div class="tp-blog-thumb-2 p-relative fix">
                            <a href="<?php echo e($post->url); ?>">
                                <?php echo e(RvMedia::image($post->image, $post->name)); ?>
                            ...
                            <div class="tp-blog-meta-2 me-1">
                                ...
                                <?php if($post->tags->isNotEmpty()): ?>
                                    <?php $__currentLoopData = $post->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e($tag->url); ?>"><?php echo e($tag->name); ?><?php if(!$loop->last): ?>, <?php endif; ?></a>
        ...
        <?php if(($buttonLabel = $shortcode->button_label) && ($buttonUrl = $shortcode->button_url ?: get_blog_page_url())): ?>
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-blog-more-2 mt-10 text-center">
                        <a href="<?php echo e($buttonUrl); ?>" class="tp-btn tp-btn-border tp-btn-border-sm">
...
<?php /**PATH C:\Users\Andropedia_2025\Desktop\anali\kiyawallet\platform\themes/shofy-fashion/partials/shortcodes/blog-posts/index.blade.php ENDPATH**/ ?>