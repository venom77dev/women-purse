...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::form.checkbox','data' => ['class' => 'export-column','name' => 'columns[]','value' => $column->getName(),'label' => $column->getLabel(),'disabled' => $column->isDisabled(),'checked' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'a74ad8dfacd4f985eb3977517615ce25::form.radio-list','data' => ['label' => trans('packages/data-synchronize::data-synchronize.export.form.format'),'name' => 'format','options' => [
                        'csv' => 'CSV',
                        'xlsx' => 'Excel',
                    ],'value' => 'csv']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make($exporter->getLayout(), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Andropedia_2025\Desktop\anali\kiyawallet\vendor\botble\data-synchronize\src\Providers/../../resources/views/export.blade.php ENDPATH**/ ?>