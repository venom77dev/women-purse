<div class="tp-product-action-2 tp-product-action-blackStyle">
    <div class="tp-product-action-item-2 d-flex flex-column">
        ...
        <button
            ...
            data-url="<?php echo e(route('public.ajax.quick-view', $product)); ?>"
        >
            ...
            <span class="tp-product-tooltip tp-product-tooltip-right"><?php echo e(__('Quick View')); ?></span>
        </button>

        <?php if(EcommerceHelper::isWishlistEnabled()): ?>
            <button
                type="button"
                class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tp-product-action-btn-2 tp-product-add-to-wishlist-btn', 'active' => $isInWishlist = is_product_in_wishlist($product->original_product->id)]); ?>"
                data-bb-toggle="add-to-wishlist" title="Add to wishlist"
                data-url="<?php echo e(route('public.wishlist.add', $product)); ?>"
                data-add-text="<?php echo e(__('Add To Wishlist')); ?>"
                data-remove-text="<?php echo e(__('Remove From Wishlist')); ?>"
            >
                ...
                <span class="tp-product-tooltip tp-product-tooltip-right">
                    <?php if($isInWishlist): ?>
                        <?php echo e(__('Remove From Wishlist')); ?>
        ...
        <?php if(EcommerceHelper::isCompareEnabled()): ?>
            <button
                type="button"
                class="<?php echo \Illuminate\Support\Arr::toCssClasses(['tp-product-action-btn-2 tp-product-add-to-compare-btn', 'active' => $isInCompare = is_product_in_compare($product->original_product->id)]); ?>"
                ...
                data-add-text="<?php echo e(__('Add To Compare')); ?>"
                data-remove-text="<?php echo e(__('Remove From Compare')); ?>"
            >
                ...
                <span class="tp-product-tooltip tp-product-tooltip-right">
                    <?php if($isInCompare): ?>
                        <?php echo e(__('Remove From Compare')); ?>
...
<?php /**PATH C:\Users\Andropedia_2025\Desktop\anali\kiyawallet\platform\themes/shofy/views/ecommerce/includes/product/style-2/actions.blade.php ENDPATH**/ ?>